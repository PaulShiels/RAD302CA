...
namespace Trip_booking.DAL
{
    ...
    public class TripInitializer : DropCreateDatabaseIfModelChanges<TripContext>
    {
        protected override void Seed(TripContext context)
        {
            ...
            {
                new Trip {name="Irish Ledgends", startDate=DateTime.Parse("01/03/2013"), endDate=DateTime.Parse("06/03/2013"), minimumGuests=6, legs_T = new List<Leg>{legs[0],legs[1],legs[2],legs[3],legs[4], legs[5]}},
                new Trip {name="Mystical Ireland", startDate=DateTime.Parse("04/02/2013"), endDate=DateTime.Parse("21/03/2013"), minimumGuests=12, legs_T = new List<Leg>{legs[6],legs[7],legs[8],legs[9],legs[10]}},//legs = new List<Leg>{ new Leg{startLocation="Desert West", endLocation = "Desert East", startDate=DateTime.Parse("12/01/2013"), endDate=DateTime.Parse("16/01/2013"),tripID=1}}},
                new Trip {name="Southern Supreme", startDate=DateTime.Parse("12/01/2013"), endDate=DateTime.Parse("26/02/2013"), minimumGuests=8, legs_T = new List<Leg>{legs[11],legs[12],legs[13],legs[14],legs[15]}},// legs = new List<Leg>{ new Leg{startLocation="Desert West", endLocation = "Desert East", startDate=DateTime.Parse("12/01/2013"), endDate=DateTime.Parse("16/01/2013"),tripID=1}}},                
